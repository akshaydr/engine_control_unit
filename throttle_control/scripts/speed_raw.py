...
def create_widgets_in_first_frame():
    ...
    label=Label(first_frame,text="WELCOME",bg="antique white",foreground="sienna",anchor=NE,font=("Engravers MT",50),fg="black",bd=5,height=1,takefocus=1,state=NORMAL,relief=FLAT,highlightthickness=1)
...
def create_widgets_in_second_frame():
    b = Label(second_frame, text="PLEASURE ENGINE",font=("Algerian",32),highlightthickness=12,foreground="sienna")       #borderwidth=2,relief=RIDGE,)
    ...
    option.config(bg="slate gray",borderwidth=5,cursor="hand2",height=2,width=20,fg="white",font=("Arial Black",18))
...
def create_widgets_in_third_frame():
    p= Label(third_frame, text="THROTTLE CONTROL",font=("Algerian",32),highlightthickness=12,foreground="sienna")
    p.config(background="antique white")          #borderwidth=2,relief=RIDGE,
    p.place(x=180,y=20)

    b = Label(third_frame, text="Enter the speed (in kmph)",font=("Rockwell Extra Bold",16),highlightthickness=12)
    b.config(background="antique white")          #borderwidth=2,relief=RIDGE,
    b.place(x=50,y=120)
